...
export default function Cases() {
  const successStories = [
    ...
    },
    {
      ...
      name: "Дмитрий",
      role: "HR-директор",
      transition: "HR бизнес партнёром → HR-директор",
      duration: "4 месяца",
      salaryIncrease: "80%",
      industry: "IT / HR-менеджмент",
      challenge: "Дмитрий работал HR бизнес партнёром в IT-компании, но хотел стать HR-директором. Не понимал, какие компетенции нужно развивать и как позиционировать себя для руководящей роли.",
    ...
    },
    {
      ...
      transition: "SMM team lead → маркетинг-директор",
      duration: "5 месяцев",
      salaryIncrease: "100%",
      industry: "SaaS / Маркетинг",
      challenge: "Елена работала SMM team lead в стартапе, но хотела стать маркетинг-директором. Не знала, как развить стратегическое мышление и получить опыт управления командой.",
